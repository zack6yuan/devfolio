export default function Experience() {
  return (
    <div className="text-black text-xl flex flex-col items-center justify-center">
      <h1 className="font-moralana text-center sm:text-5xl sm:mt-10 md:text-6xl xs:text-5xl lg:mb-2 xxs:text-4xl">
        Education
      </h1>
      <p className="font-moralana text-center max-w-lg sm:text-md xs:text-lg xs:mt-4 lg:text-xl xxs:text-md xxs:mt-2 px-4">
