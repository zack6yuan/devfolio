...
export default function Archipelago() {
  return (
    ...
    <p className="text-5xl animate-wiggle">🏝️</p>
      <h1 className="text-4xl text-gray-800 font-bold">The Archipelago</h1>
      <p className="text-gray-500">Every island is a shipped Project. Explore Them!</p>
      ...
      <div className="relative w-100 h-100">
        {/* Back card */}
        <div className="absolute inset-0 bg-[#00ddff79] rounded-4xl"></div>

        {/* Front card */}
        <div className="absolute bottom-3 left-1/2 -translate-x-1/2 h-100 w-100 bg-teal-500/10 border-3 border-teal-500 rounded-4xl p-6">
