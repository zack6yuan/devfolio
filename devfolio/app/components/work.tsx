      ...
      <div className="flex flex-col items-start gap-5 pt-12 sm:pt-15 pb-10 px-5 bg-black">
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-8 font-sora w-full max-w-5xl text-sm sm:text-md sm:text-base text-left px-8">
          ...
          <div className="flex gap-2">
            {tags1.map((tag, x) => (
              <div
                className="rounded-full py-1 px-3 gap border border-gray-500/60 text-[12px] font-mono"
                key={x}
              >
                {tag}
              </div>
          ...
          <hr className="border-t border-white/20 flex-1 my-5" />
        </div>
      </div>

      <div className="flex flex-col items-start gap-5 sm:pt-15 pb-10 px-5 bg-black">
        <hr className="border-t border-white/20 flex-1" />
        <div className="flex items-center gap-3 w-full justify-between pr-5">
          <div className="flex items-center gap-3">
